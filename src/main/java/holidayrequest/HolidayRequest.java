...
public class HolidayRequest {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < tasks.size(); i++) {
			System.out.println((i + 1) + ") " + tasks.get(i).getName() + "taskId: " + tasks.get(i).getId() + "    Assignee: " + tasks.get(i).getAssignee());
			taskService.addCandidateGroup(tasks.get(i).getId(), "managers");
		}
